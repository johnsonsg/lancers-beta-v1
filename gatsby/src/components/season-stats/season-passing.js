...
function PassingStats() {
  ...
  // // Get Mapped Data
  // const seasonPassingStats = passing?.map((filter) => [
  //   filter?.playerpassingstats?.map((filterplayer) => [
  //     filterplayer?.player[0].name,
  //     filterplayer?.passyds,
  //   ]),
  // ]);
  // console.log('PASSINGDATA-V1', seasonPassingStats);
